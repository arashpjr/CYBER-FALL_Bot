...
global.channelLink = "https://whatsapp.com/channel/0029VbBWxx16BIEqTMnon40o";
global.ytch = "C F. A RASH_404";
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbBWxx16BIEqTMnon40o' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/LV9nmTPj0Jw2YfIIYGsdRx?mode=wwt` 
                }, { quoted: message });
                return;
            }
        }
        ...
        // If a command was executed, show typing status after command execution
          if (command === 'pair') {
    await pairCommand(sock, chatId, m, q);
}
